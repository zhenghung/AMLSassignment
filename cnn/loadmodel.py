...
cur_dir = "/home/bryan/AppliedML_Assessment/AMLSassignment/models/keras-facenet/"
# name = cur_dir + '/../models/keras-facenet/'
# feature_tested = 'eyeglasses'
# load json and create model
# json_file = open(name + 'model.json', 'r')
# loaded_model_json = json_file.read()
# json_file.close()
loaded_model = load_model(cur_dir+'model/facenet_keras.h5')
# load weights into new model
loaded_model.load_weights(cur_dir + "weights/facenet_keras_weights.h5")
